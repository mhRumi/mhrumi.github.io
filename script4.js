...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll(
        '.interest-item, .education-item, .timeline-item, .research-card, ' +
        '.teaching-item, .skill-category, .pub-item, .cert-card, ' +
...
if (footerText) {
    footerText.textContent = `© ${currentYear} MD Mehedi Hasan. All rights reserved.`;
}
